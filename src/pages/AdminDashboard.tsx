    ...
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:block border-l pl-4 border-border">
              ...
              <p className="text-xs text-muted-foreground">Manage all student complaints</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
      ...
      <main className="flex-1 container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1">Monitor and manage all student complaints in one place</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          >
            ...
            <CardContent>
              <div className="text-3xl font-bold text-green-600">{complaints.filter(c => c.status === "resolved").length}</div>
                  ...
                  <div key={complaint.id} className="p-4 hover:bg-muted/30 transition-colors">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-base mb-1 truncate">{complaint.title}</h3>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-3">
                      {complaint.reporter && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs">({complaint.reporter.email})</span>
                        </div>
                      )}
                      <div className="flex items-center gap-1.5">
                    ...
                    {expandedComplaint === complaint.id && (
                      <div className="mt-4 pt-4 border-t space-y-4 bg-muted/20 -mx-4 px-4 pb-4">
                        {/* Full Description */}
                        <div>
                          ...
                          {statusHistory[complaint.id]?.length > 0 ? (
                            <div className="space-y-2 max-h-48 overflow-y-auto">
                              {statusHistory[complaint.id].map((history) => (
                                <div key={history.id} className="text-xs bg-background p-2 rounded-lg">
                                  ...
                                  {history.note && (
                                    <p className="mt-1 text-foreground bg-muted/50 p-1.5 rounded">
                                      {history.note}
                                    </p>
                                  )}
                                </div>
